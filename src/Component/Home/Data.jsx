...
const Data = () => {
    return (
        <div className='koko'>
            ...
            I'm creative developer based on MERN, i'm very passionate and dedicated to my work.
            </p>

            <a href="#contract" className="button button-flex">Say Hello 
            <svg
                  class="button__icon home-hand"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
